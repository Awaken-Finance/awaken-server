...
namespace AwakenServer.Trade
{
    ...
    public class TradePairAppServiceTests : TradeTestBase
    {
        ...
        public async Task UpdateLiquidityTest()
        {
            ...
            marketDataSnapshot.TVL.ShouldBe(10100d);
            ...
            marketDataSnapshot.TVL.ShouldBe(22200d);
            ...
            marketDataSnapshot.TVL.ShouldBe(12100d);
            marketDataSnapshot.ValueLocked0.ShouldBe(100);
            ...
            marketDataSnapshot.TVL.ShouldBe(12200d);
            marketDataSnapshot.ValueLocked0.ShouldBe(200);
            marketDataSnapshot.ValueLocked1.ShouldBe(12000);
        ...
        public async Task SyncTradePairWithNewToken_Test()
        {
            ...
            await _tradePairAppService.SyncPairAsync(TradePairInfoDto, new ChainDto()
            {
                Id = ChainId,
                Name = ChainName
            });
