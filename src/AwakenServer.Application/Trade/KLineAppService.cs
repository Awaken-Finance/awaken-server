        ...
        public async Task<ListResultDto<KLineDto>> GetListAsync(GetKLinesInput input)
        {
            ...
            if (list.Item1 == 0 || list.Item2.First().Timestamp != timestampMin)
            {
                ...
                if (lastKLine != null)
                {
                    list.Item2.Insert(0,new Index.KLine
                    {
                        ...
                        CloseWithoutFee = lastKLine.CloseWithoutFee,
                        HighWithoutFee = lastKLine.CloseWithoutFee,
                        LowWithoutFee = lastKLine.CloseWithoutFee,
                        OpenWithoutFee = lastKLine.CloseWithoutFee,
                        Volume = 0,
            ...
            if (list.Item2.Count != 0 && list.Item2.Last().Timestamp != timestampMax)
            {
                ...
                list.Item2.Add(new Index.KLine
                {
                    ...
                    Low = lastItem.Close,
                    Open = lastItem.Close,
                    CloseWithoutFee = lastItem.CloseWithoutFee,
                    HighWithoutFee = lastItem.CloseWithoutFee,
                    LowWithoutFee = lastItem.CloseWithoutFee,
                    OpenWithoutFee = lastItem.CloseWithoutFee,
                    Volume = 0,
